...
=== One Space Indent [[one-space-indent]]
...
=== Vertically Align Let And Map [[vertically-align-let-and-map]]
...
=== Dont Def Vars Inside Fns [[dont-def-vars-inside-fns]]
...
=== Dont Shadow Clojure Core [[dont-shadow-clojure-core]]
...
=== When Instead Of Single Branch If [[when-instead-of-single-branch-if]]
...
=== When Not Instead Of Single Branch If Not [[when-not-instead-of-single-branch-if-not]]
...
=== Dont Flag Constants [[dont-flag-constants]]
...
=== Dont Write Macro If Fn Will Do [[dont-write-macro-if-fn-will-do]]
...
=== Refactor Dont Comment [[refactor-dont-comment]]
...
=== Lib Coordinates [[lib-coordinates]]
...
=== Lib Min Dependencies [[lib-min-dependencies]]
...
=== Lib Core Separate From Tools [[lib-core-separate-from-tools]]
